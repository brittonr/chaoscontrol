...
| 2026-03-31 | self | "leader commit advanced after proposal" sometimes-assertion: 0/1511 true | Leader calls try_advance_commit() right after appending entry but peers haven't replicated yet, so commit rarely advances immediately. Not a real violation — just a timing artifact. |
