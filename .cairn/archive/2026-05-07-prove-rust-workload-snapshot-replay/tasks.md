...
- [x] [depends:dogfood] Run the Rust workload accepted snapshot verdict dogfood rail and curate concise evidence.
- [x] [depends:evidence] Update replay proof coverage/readiness manifests for the Rust workload proof.
- [x] [depends:verification] Run strict OpenSpec validation, replay proof coverage checks, focused Rust/Nix checks, and `git diff --check`.
