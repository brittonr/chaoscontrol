# in-process-deterministic-simulator Specification

## Purpose
Define the bounded, adapter-based in-process deterministic simulator rail used for replay-readiness evidence. This spec deliberately keeps simulator evidence separate from arbitrary guest VM replay proof and full FoundationDB-style simulator parity.
## Requirements
