...
## Purpose
TBD - created by archiving change separate-sdk-and-controller-licenses. Update Purpose after archive.
## Requirements
...
The change SHALL run Cairn validation and focused package metadata, dependency-policy, license-artifact, positive-fixture, and negative-fixture checks.
