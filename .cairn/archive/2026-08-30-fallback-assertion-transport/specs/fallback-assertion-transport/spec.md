...
Let any guest process emit assertion and lifecycle evidence without linking the Rust SDK, while keeping the property oracle and catalog identity authoritative.
