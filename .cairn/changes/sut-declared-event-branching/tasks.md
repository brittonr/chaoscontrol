...
- [ ] [depends:event-branching-baseline] Add the declared marker SDK surface with stable identity and structured details. r[chaoscontrol.event_branching.marker_api]
...
- [ ] [depends:event-branching-frontier] Bind markers to parent snapshots and replay verdicts with identity validation. r[chaoscontrol.event_branching.evidence_binding]
